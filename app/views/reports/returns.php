...
<div class="d-flex justify-content-between align-items-end mb-3">
  <div><h4 class="mb-0">Laporan Pengembalian</h4><div class="text-muted small">Periode kembali</div></div>
  <a class="btn btn-outline-secondary"
   href="?r=reports/returns_pdf&from=<?= urlencode($from) ?>&to=<?= urlencode($to) ?>"
   target="_blank">
  PDF
</a>
</div>
...
<div class="card shadow-sm mb-3">
  <div class="card-body">
    <form class="row g-2" method="get">
      <input type="hidden" name="r" value="reports/returns">
  ...
  <div class="table-responsive">
    <table class="table table-striped table-hover align-middle mb-0">
      <thead class="table-light">
        <tr><th>ID</th><th>Member</th><th>Barcode</th><th>Judul</th><th>Tgl Kembali</th><th>Petugas</th></tr>
      </thead>
      <tbody>
        <?php if (empty($rows)): ?>
          <tr><td colspan="6" class="text-center text-muted py-4">Data kosong</td></tr>
