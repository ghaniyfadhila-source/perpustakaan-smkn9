...
<title>Login Siswa - <?= APP_NAME ?? 'Perpustakaan SMKN 9 Semarang' ?></title>
    ...
    <div class="row min-vh-100">
      ...
      <div class="col-lg-7 d-none d-lg-flex flex-column justify-content-center left-panel">
        ...
        <div class="feature-grid">
          ...
          <span class="chip"><i class="bi bi-geo-alt"></i> Dashboard Personal</span>
          <span class="chip"><i class="bi bi-journal-text"></i> Request Peminjaman</span>
          <span class="chip"><i class="bi bi-book me-2"></i> Katalog Buku</span>
        </div>
        ...
        <div class="school-note">
          ...
          <div class="small" style="color:#475569;">
            Gunakan akun siswa yang terdaftar. Jika lupa password, hubungi pembimbing atau admin.
          </div>
        </div>
      </div>
